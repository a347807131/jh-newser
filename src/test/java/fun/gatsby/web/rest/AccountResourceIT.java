...
import fun.gatsby.config.Constants;
import fun.gatsby.domain.PersistentToken;
import fun.gatsby.domain.User;
import fun.gatsby.repository.AuthorityRepository;
import fun.gatsby.repository.PersistentTokenRepository;
import fun.gatsby.repository.UserRepository;
import fun.gatsby.security.AuthoritiesConstants;
import fun.gatsby.service.UserService;
import fun.gatsby.service.dto.PasswordChangeDTO;
import fun.gatsby.service.dto.UserDTO;
import fun.gatsby.web.rest.vm.KeyAndPasswordVM;
import fun.gatsby.web.rest.vm.ManagedUserVM;
