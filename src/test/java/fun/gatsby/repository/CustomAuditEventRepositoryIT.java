...
import fun.gatsby.config.audit.AuditEventConverter;
import fun.gatsby.domain.PersistentAuditEvent;
...
import static fun.gatsby.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
