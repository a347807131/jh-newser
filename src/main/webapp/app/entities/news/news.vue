<template>
    <div>
        <h2 id="page-heading">
            ...
            <router-link :to="{name: 'NewsCreate'}" tag="button" id="jh-create-entity" class="btn btn-primary float-right jh-create-entity create-news">
        ...
        <b-modal ref="removeEntity" id="removeEntity" >
            ...
            <div class="modal-body">
                <p id="jhi-delete-news-heading" v-text="$t('jhdApp.news.delete.question', {'id': removeId})">Are you sure you want to delete this News?</p>
            </div>
